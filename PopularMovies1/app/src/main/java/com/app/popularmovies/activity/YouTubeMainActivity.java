...
/**
 * Created by ravindmaurya on 18/4/16.
 */
public class YouTubeMainActivity extends YouTubeBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras()!=null){
            YOUTUBE_VIDEO_CODE= getIntent().getExtras().getString("youtubecode");
        }

        youTubeView = (YouTubePlayerView) findViewById(R.id.youtube_view);

        // Initializing video player with developer key
        youTubeView.initialize(AppConstants.DEVELOPER_YOU_TUBE_KEY, this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RECOVERY_DIALOG_REQUEST) {
            ...
            getYouTubePlayerProvider().initialize(AppConstants.DEVELOPER_YOU_TUBE_KEY, this);
        }
    }
